...
│                         technopreneurship and configuration for tools like black
│
...
│
└── technopreneurship   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes technopreneurship a Python module
    │
